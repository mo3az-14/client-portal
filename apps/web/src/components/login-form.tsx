...
export function LoginForm({
    ...
    const { emailLogin, socialGoogleLogin } = userStore()
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="grid gap-6">
                            <div className="flex flex-col gap-4">
                                <Button type="button" onClick={() => socialGoogleLogin()} variant="outline" className="w-full">
                            ...
                            <div className="relative text-center text-sm">
                                <span className="bg-crd text-muted-foreground relative z-10 px-2">
                                    Or continue with
                                </span>
                            </div>
                            <div className="grid gap-6">
